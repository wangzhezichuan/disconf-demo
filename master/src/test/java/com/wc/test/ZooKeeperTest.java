...
public class ZooKeeperTest {
    ...
    static public ZooKeeperTest Instance(){  
        if(static_ == null){  
            static_ = new ZooKeeperTest();  
        }  
        return static_;  
    }  
    ...
    static private ZooKeeperTest static_;  
    public static void main(String args[]){  
        String hostports = "192.168.0.128:2181,192.168.0.128:2182,192.168.0.128:2183";  
          
        ZooKeeperTest.Instance().Init(hostports, 1000);  
          
        String str = ZooKeeperTest.Instance().Get("conf.logicpoint.subscriberserverip");  
        str = ZooKeeperTest.Instance().Get("conf.logicpoint.subscriberserverport");  
